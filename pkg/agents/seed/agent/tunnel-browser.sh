...
# Is the tunnel for this workspace up and carrying? The ssh process alive, and 9223 answering inside
# the pod (a dead exec channel leaves ssh running but the forward broken).
alive() {
...
tunnel_one() {
  ...
  # Stale/broken: drop any old ssh before starting a fresh one.
